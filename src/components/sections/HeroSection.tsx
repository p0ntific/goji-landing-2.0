                ...
                <div className="flex flex-col px-[25px] md:px-12 gap-6 md:gap-8 lg:flex-row items-start lg:items-end lg:justify-between">
                    ...
                    <div className="flex flex-col gap-4 md:gap-6 w-full lg:w-auto">
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <Link
                                href="#cal"
                                className="flex justify-between md:justify-start gap-3 md:gap-5 items-center border p-2 pl-3 md:pl-4 text-sm md:text-base font-medium rounded-xl bg-white text-[#101010]"
                    ...
                    <div className="relative z-10 flex h-full flex-col justify-between p-6 md:p-12">
                        ...
                        <div className="mt-6 md:mt-8">
                            <Button
                                ...
                                href="#cal"
                                variant="bordered"
                                className="w-full md:w-auto text-white border-[rgba(255,255,255,0.1)] p-4 text-sm md:text-base"
                            >
